...
exe_file    = '../ncrc2.default-prod-openmp/exec/fms_idealized_moist.x'
...
shutil.copyfile(exe_file, exp_dir + 'fms_idealized_moist.x')
shutil.copyfile(template_dir + 'combine', exp_dir + 'combine')
shutil.copyfile(template_dir + 'diag_table', exp_dir + 'diag_table')
shutil.copyfile(template_dir + 'field_table_void', exp_dir + 'field_table')
os.chmod(template_dir + 'restartNum', READ_WRITE_EXE)
os.chmod(exp_dir + 'fms_idealized_moist.x', READ_WRITE_EXE)
